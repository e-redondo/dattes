function export_profiles_json(dattes_struct, options, file_out)
% export_profiles_json export profiles from DATTES struct to json file
%
% 
% Usage:
% export_profiles_json(dattes_struct, options, file_out)
%
% Input:
...
if ~isfield(dattes_struct,'profiles')
     fprintf('ERROR export_profiles_json:No profiles found in DATTES struct\n');
     return
end
%check options
...
if ~exist('fileout','var')
    file_suffix = '_dattes_profiles.json';
