...
%0.4.- phase doit avoir les champs 'tIni' et 'tFin'
if ~isfield(phase,'tIni') || ~isfield(phase,'tFin')
    fprintf('get_phase: ERREUR, phase doit avoir des champs tIni et tFin\n');
    return;
end
...
indices = t>=phase.tIni & t<=phase.tFin;
tp = t(indices);
