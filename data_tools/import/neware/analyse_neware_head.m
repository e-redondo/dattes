function [variable_names, unit_names, date_test, source_file,test_params] = analyse_neware_head(file_name, header, first_data_line)
% analyse_neware_head Analyse header and variables of neware files
%
%
% Usage:
% [variable_names, unit_names, date_test, source_file,test_params] = analyse_neware_head(file_name, header, first_data_line)
% Inputs : 
% - file_name: Result file_name from the Neware cycler
% Outputs : 
