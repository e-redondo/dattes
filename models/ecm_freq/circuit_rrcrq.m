function Z = circuit_rrcrq(Zparams,f)
% function Z = circuit_rrcrq(Q ,alpha,f)
% Impedance spectrum for the following circuit:
% R + R//L + R//C + ... + R//C + R//Q + ... + R//Q
%
...
%     - RQ (px1 double): real positive number, m_th capacitor resistor
...
%
% See also circuit_rc, circuit_rq, circuit_rrcq, circuit_rrcrq, circuit
%
